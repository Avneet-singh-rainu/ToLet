...
const SearchPage = () => {
  ...
  useEffect(() => {
    const loadData = async () => {
      setIsLoading(true);
      try {
        await Promise.all([fetchRecentSearches(), fetchRecentlyViewed()]);
      } catch (err) {
  ...
  return (
    <div className="bg-white min-h-screen relative">
      {/* Fixed Navigation and Search Bar */}
      <div className="sticky top-0 z-10 bg-white">
        <Navigation
          ...
          onNotificationClick={handleNotificationClick}
        />
        <div className="flex items-center bg-gray-100 rounded-full px-3 py-2 mx-4 mt-2">
      ...
      {/* Scrollable Content */}
      <div className="p-4 pt-2 overflow-y-auto" style={{ maxHeight: "calc(100vh - 112px)" }}>
